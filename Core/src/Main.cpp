...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE, LPSTR, int)
{
    ...
    while (!done)
    {
        ...
        {
            app.windowWidth = g_ResizeWidth;
            app.windowHeight = g_ResizeHeight;
            CleanupRenderTarget();
...
LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_DESTROY:
        ...
        return 0;
    case WM_MOVE:
        app.windowPosX = (UINT)LOWORD(lParam);
        app.windowPosY = (UINT)HIWORD(lParam);
        return 0;
    }
